...
Color kScaffoldBackgroundColor = const Color(0xFF343541);
Color kCardColor = const Color(0xFF444654);
...
//   List<DropdownMenuItem<String>>? modelsItem = List<DropdownMenuItem<String>>.generate(
//     models.length,
